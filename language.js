export default {
  ...
  static_notification_title: 'Gixtic Notification',
  ...
  book_your_ride_menu: 'Book Your Delivery',
  profile_setting_menu: 'Profile Settings',
  my_wallet_menu: 'My Wallet',
  my_rides_menu: 'My Deliveries',
  ...
  password_update_messege: 'Password successfully updated',
  ...
  old_password_validation_error: 'Please enter your old password',
  new_password_validation_error: 'Please enter a new password',
  update_button: 'Update Now',
  update_profile_title: 'Upadate Profile',
  map_screen_where_input_text: 'Pick up ?',
  map_screen_drop_input_text: 'Drop off ?',
  driver_finding_alert: 'Finding Despatch rider around',
  no_driver_found_alert_title: 'Attention!',
  no_driver_found_alert_messege: 'Sorry, No Riders found right now.Please try again later',
  no_driver_found_alert_OK_button: 'OK',
  no_driver_found_alert_TRY_AGAIN_button: 'Try Again',
  pickup_and_drop_location_blank_error: 'Select pickup and drop off location',
  pickup_location_blank_error: 'Select pickup location',
  drop_location_blank_error: 'Select drop location',
  car_type_blank_error: 'Select delivery type',
  congratulation: 'Congratulations!',
  refferal_bonus_messege_text: 'Your referral bonus ammount -',
  map_screen_title: 'GixTic',
  cab_selection_title: 'Select Your Delivery Ride',
  cab_selection_subtitle: 'Tap to select delivery type and book now',
  ...
  ride_list_title: 'My Delivery',
  no_car_assign_text: 'No despatch rider assign',
  not_found_text: 'Not Found',
  ride_details_page_title: 'My Delivery Details',
  you_rated_text: 'You Rated',
  car_no_not_found: 'Ride Number Not found',
  track_now_button: 'Track Now',
  bill_details_title: 'Bill Details',
  your_trip: 'Your Delivery',
  discount: 'Discount',
  promo_apply: '(Promo Apply)',
  grand_total: 'Grand Total',
  payment_status: 'Payment Status',
  paynow_button: 'Pay Now',
  call_driver: 'Call Rider',
  booked_cab_title: 'Booked Delivery',
  you_selected: 'You Selected -',
  otp: 'OTP :',
  driver_assign_messege: 'A Despatch rider will Respond Soon..',
  cancel_ride: 'Cancel Delivery',
  rider_cancel_text: 'Delivery Cancelled',
  cancel_messege1: 'Your delivery with Booking Id',
  ...
  skip: 'Skip',
  receipt: 'Receipt',
  rate_ride: 'PLEASE RATE YOUR DELIVERY',
  err: 'Error!',
  route_not_found: 'Cannot find any route',
  sorry: 'Sorry',
  multipleBooking: 'GixTic currently doesn\'t support multiple bookings.',
  driver_not_found: 'We cannot assign despatch rider at this moment. contact to adminstrator !!',
  new_booking_request_push_notification: 'You Have A New Delivery Request',
  fare_details: 'Fare Details',
  base_fare: 'Base Fare',
  convenience_free: 'Convenience Fees',
  total_fare: 'Total Fare',
  inclusive_tax: '(Inclusive all Taxes)',
  nb: 'N.B.: Your fare will increase if toll, route and destination changes or if ride took longer due to traffic or other',
